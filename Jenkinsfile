        ...
        stage("copy the files to ansible server"){
            steps{
                ...
                sshagent(['ANSIBLE_SERVER']){
                    sh 'scp Dockerfile ansible-admin@172.31.7.122:/opt/weshopify-brands-ci'
                    sh 'scp weshopify-brands-svc-playbook.yml ansible-admin@172.31.7.122:/opt/weshopify-brands-ci'
