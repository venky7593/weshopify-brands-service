...
#com/durgasoft/weshopify-brands-service/
ARTIFACT_SERVER_URL=http://15.207.64.68:8082/artifactory
ARTIFACT_REPO_NAME=libs-snapshot-local
ARTIFACT_LOC=com/durgasoft/weshopify-brands-service
ARTIFACT_VERSION=0.0.1-SNAPSHOT

#http://15.207.64.68:8082/artifactory/libs-snapshot-local/
#com/durgasoft/weshopify-brands-service/0.0.1-SNAPSHOT
...
ARTIFACT_NAME=weshopify-brands-svc
ARTIFACTORY_ARTIFACT_NAME=weshopify-brands-service
